...
CREATE TABLE IF NOT EXISTS `BUCKETING_COLS` (
  ...
  `BUCKET_COL_NAME` varchar(256) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `COLUMNS_V2` (
  ...
  `COLUMN_NAME` varchar(128) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `DATABASE_PARAMS` (
  ...
  `PARAM_KEY` varchar(180) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `DBS` (
  `DB_ID` bigint(20) NOT NULL,
  `DESC` varchar(4000) CHARACTER SET utf8 DEFAULT NULL,
  `DB_LOCATION_URI` varchar(4000) CHARACTER SET utf8 NOT NULL,
  `NAME` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `OWNER_NAME` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `DB_PRIVS` (
  ...
  `GRANTOR` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `GRANTOR_TYPE` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `PRINCIPAL_NAME` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `PRINCIPAL_TYPE` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `DB_PRIV` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `GLOBAL_PRIVS` (
  ...
  `PRINCIPAL_NAME` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `PRINCIPAL_TYPE` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `USER_PRIV` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `IDXS` (
  ...
  `INDEX_HANDLER_CLASS` varchar(4000) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `INDEX_PARAMS` (
  `INDEX_ID` bigint(20) NOT NULL,
  `PARAM_KEY` varchar(256) CHARACTER SET utf8 NOT NULL,
  `PARAM_VALUE` varchar(4000) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `NUCLEUS_TABLES` (
  `CLASS_NAME` varchar(128) CHARACTER SET utf8 NOT NULL,
  `TABLE_NAME` varchar(128) CHARACTER SET utf8 NOT NULL,
  `TYPE` varchar(4) CHARACTER SET utf8 NOT NULL,
  `OWNER` varchar(2) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `PARTITIONS` (
  ...
  `CREATE_TIME` int(11) NOT NULL,
  `LAST_ACCESS_TIME` int(11) NOT NULL,
  `PART_NAME` varchar(767) CHARACTER SET utf8 DEFAULT NULL,
  `SD_ID` bigint(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `PARTITION_EVENTS` (
  ...
  `DB_NAME` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `EVENT_TIME` bigint(20) NOT NULL,
  `EVENT_TYPE` int(11) NOT NULL,
  `PARTITION_NAME` varchar(767) CHARACTER SET utf8 DEFAULT NULL,
  `TBL_NAME` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `PARTITION_KEYS` (
  ...
  `PKEY_NAME` varchar(128) CHARACTER SET utf8 NOT NULL,
  `PKEY_TYPE` varchar(767) CHARACTER SET utf8 NOT NULL,
  `INTEGER_IDX` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `PART_COL_PRIVS` (
  ...
  `COLUMN_NAME` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `CREATE_TIME` int(11) NOT NULL,
  `GRANT_OPTION` smallint(6) NOT NULL,
  `GRANTOR` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `GRANTOR_TYPE` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  ...
  `PRINCIPAL_NAME` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `PRINCIPAL_TYPE` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `PART_COL_PRIV` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `PART_PRIVS` (
  ...
  `PRINCIPAL_NAME` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `PRINCIPAL_TYPE` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `PART_PRIV` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ROLES` (
  ...
  `CREATE_TIME` int(11) NOT NULL,
  `OWNER_NAME` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `ROLE_NAME` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  PRIMARY KEY (`ROLE_ID`),
...
CREATE TABLE IF NOT EXISTS `SDS` (
  ...
  `INPUT_FORMAT` varchar(4000) CHARACTER SET utf8 DEFAULT NULL,
  `IS_COMPRESSED` bit(1) NOT NULL,
  `IS_STOREDASSUBDIRECTORIES` bit(1) NOT NULL,
  `LOCATION` varchar(4000) CHARACTER SET utf8 DEFAULT NULL,
  `NUM_BUCKETS` int(11) NOT NULL,
  `OUTPUT_FORMAT` varchar(4000) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `SERDES` (
  ...
  `NAME` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `SLIB` varchar(4000) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `SKEWED_COL_NAMES` (
  `SD_ID` bigint(20) NOT NULL,
  `SKEWED_COL_NAME` varchar(256) CHARACTER SET utf8 DEFAULT NULL,
  `INTEGER_IDX` int(11) NOT NULL,
  PRIMARY KEY (`SD_ID`,`INTEGER_IDX`),
...
CREATE TABLE IF NOT EXISTS `SKEWED_STRING_LIST_VALUES` (
  `STRING_LIST_ID` bigint(20) NOT NULL,
  `STRING_LIST_VALUE` varchar(256) CHARACTER SET utf8 DEFAULT NULL,
  `INTEGER_IDX` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `TBLS` (
  ...
  `DB_ID` bigint(20) DEFAULT NULL,
  `LAST_ACCESS_TIME` int(11) NOT NULL,
  `OWNER` varchar(767) CHARACTER SET utf8 DEFAULT NULL,
  `RETENTION` int(11) NOT NULL,
  `SD_ID` bigint(20) DEFAULT NULL,
  `TBL_NAME` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `TBL_TYPE` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `TBL_COL_PRIVS` (
  ...
  `PRINCIPAL_NAME` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `PRINCIPAL_TYPE` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `TBL_COL_PRIV` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `TBL_ID` bigint(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `TBL_PRIVS` (
  ...
  `PRINCIPAL_NAME` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `PRINCIPAL_TYPE` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `TBL_PRIV` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `TBL_ID` bigint(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `TAB_COL_STATS` (
 ...
 `DB_NAME` varchar(128) CHARACTER SET utf8 NOT NULL,
 `TABLE_NAME` varchar(128) CHARACTER SET utf8 NOT NULL,
 `COLUMN_NAME` varchar(128) CHARACTER SET utf8 NOT NULL,
 `COLUMN_TYPE` varchar(128) CHARACTER SET utf8 NOT NULL,
 `TBL_ID` bigint(20) NOT NULL,
 `LONG_LOW_VALUE` bigint(20),
 `LONG_HIGH_VALUE` bigint(20),
 `DOUBLE_HIGH_VALUE` double(53,4),
 `DOUBLE_LOW_VALUE` double(53,4),
 `BIG_DECIMAL_LOW_VALUE` varchar(4000) CHARACTER SET utf8,
 `BIG_DECIMAL_HIGH_VALUE` varchar(4000) CHARACTER SET utf8,
...
CREATE TABLE IF NOT EXISTS `PART_COL_STATS` (
 ...
 `DB_NAME` varchar(128) CHARACTER SET utf8 NOT NULL,
 `TABLE_NAME` varchar(128) CHARACTER SET utf8 NOT NULL,
 `PARTITION_NAME` varchar(767) CHARACTER SET utf8 NOT NULL,
 `COLUMN_NAME` varchar(128) CHARACTER SET utf8 NOT NULL,
 `COLUMN_TYPE` varchar(128) CHARACTER SET utf8 NOT NULL,
 `PART_ID` bigint(20) NOT NULL,
 `LONG_LOW_VALUE` bigint(20),
...
CREATE TABLE IF NOT EXISTS `TYPES` (
  ...
  `TYPE1` varchar(767) CHARACTER SET utf8 DEFAULT NULL,
  `TYPE2` varchar(767) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `TYPE_FIELDS` (
  ...
  `FIELD_TYPE` varchar(767) CHARACTER SET utf8 NOT NULL,
  `INTEGER_IDX` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `FUNCS` (
  ...
  `CLASS_NAME` VARCHAR(4000) CHARACTER SET utf8,
  `CREATE_TIME` INT(11) NOT NULL,
  `DB_ID` BIGINT(20),
  `FUNC_NAME` VARCHAR(128) CHARACTER SET utf8,
  `FUNC_TYPE` INT(11) NOT NULL,
  `OWNER_NAME` VARCHAR(128) CHARACTER SET utf8,
  `OWNER_TYPE` VARCHAR(10) CHARACTER SET utf8,
  PRIMARY KEY (`FUNC_ID`),
...
CREATE TABLE IF NOT EXISTS `FUNC_RU` (
  ...
  `RESOURCE_URI` VARCHAR(4000) CHARACTER SET utf8,
  `INTEGER_IDX` INT(11) NOT NULL,
